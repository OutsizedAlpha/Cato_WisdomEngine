...
- direct CLI for quant workflow: `market-refresh`, `scenario-refresh`, `scenario-diff`, and `probability-brief`
...
- The probabilistic workflow currently stays on the direct CLI because the arguments and refresh choices matter more than launcher convenience: use `.\cato.cmd market-refresh`, `.\cato.cmd scenario-refresh`, `.\cato.cmd scenario-diff`, and `.\cato.cmd probability-brief`.
...
- For the deeper workflow explanation, read `docs/operator_guide.md`, `docs/authored_output_handoff.md`, `docs/report_handoff.md`, `docs/scenario_engine.md`, and `docs/release_runbook.md`.
