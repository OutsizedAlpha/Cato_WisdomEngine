...
<!-- CATO:BEGIN_MANAGED_BLOCK concepts -->
## Managed Linked Concepts

- [[concepts/inflation-expectations|inflation expectations]]
- [[concepts/pricing-power|pricing power]]
- [[concepts/energy-prices|energy prices]]
- [[concepts/energy-security|energy security]]
- [[concepts/shipping|shipping]]
- [[concepts/trade|trade]]
- [[concepts/policy-regimes|policy regimes]]
- [[concepts/hard-power|hard power]]
- [[concepts/current-account|current account]]
- [[concepts/external-balance|external balance]]
