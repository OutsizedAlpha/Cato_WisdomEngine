---
id: CLAIM-2026-AA44C04552E5
kind: claim-page
title: "In this setup, broad equity indices can still hold up for a while because the data are not rece…"
status: active
...
# In this setup, broad equity indices can still hold up for a while because the data are not rece…

## Claim

In this setup, broad equity indices can still hold up for a while because the data are not recessionary.
