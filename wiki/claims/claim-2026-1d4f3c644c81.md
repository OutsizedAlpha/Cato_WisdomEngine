---
id: CLAIM-2026-1D4F3C644C81
kind: claim-page
title: "That is precisely the kind of combination that can keep gilts under pressure even if the real e…"
status: superseded
...
# That is precisely the kind of combination that can keep gilts under pressure even if the real e…

## Claim

That is precisely the kind of combination that can keep gilts under pressure even if the real economy itself is only trudging along.
